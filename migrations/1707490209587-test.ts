...
export class Test1707490209587 implements MigrationInterface {
  name = 'Test1707490209587';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_roleincompany_enum" AS ENUM('owner', 'admin', 'member', 'none')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(20) NOT NULL, "firstname" character varying(25) NOT NULL, "lastName" character varying(25) NOT NULL, "password" character varying NOT NULL, "isOwnerCompany" boolean NOT NULL DEFAULT false, "roleInCompany" "public"."user_roleincompany_enum" NOT NULL DEFAULT 'none', "companyId" uuid, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "company" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL, "description" character varying(1200) NOT NULL, "ownerId" uuid, CONSTRAINT "REL_ee87438803acb531639e8284be" UNIQUE ("ownerId"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL, "description" character varying(1200) NOT NULL, "companyId" uuid, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."task_tracker_enum" AS ENUM('error', 'improvement')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."task_status_enum" AS ENUM('new', 'in_working', 'closed')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."task_priority_enum" AS ENUM('low', 'normal', 'high', 'immediate')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_861fc64a5d366b3cfe90a0f4a35" FOREIGN KEY ("assignedId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
